...
export declare namespace useLoadableQuery {
    ...
    type Result<TData = unknown, TVariables extends OperationVariables = OperationVariables, TStates extends DataState<TData>["dataState"] = DataState<TData>["dataState"], TErrorPolicy extends ErrorPolicy | undefined = undefined> = [
        loadQuery: LoadQueryFunction<TVariables>,
        queryRef: QueryRef<TData, TVariables, TStates> | null,
        handlers: Handlers<TData, TVariables, TErrorPolicy>
    ];
    interface Handlers<TData = unknown, TVariables extends OperationVariables = OperationVariables, TErrorPolicy extends ErrorPolicy | undefined = undefined> {
        /**
    ...
    type OptionsFor<TOptions> = Exclude<keyof TOptions, keyof useLoadableQuery.Options> extends (infer InvalidOptionNames extends string) ? [
        InvalidOptionNames
    ...
    namespace Signatures {
        ...
        */
        interface Classic {
            ...
            * @returns A tuple in the form of `[loadQuery, queryRef, handlers]`
            */
            <TData, TVariables extends OperationVariables, _INFERENCE_ONLY_DO_NOT_SPECIFY extends "inferred", TErrorPolicy extends ErrorPolicy | undefined = undefined>(query: DocumentNode | TypedDocumentNode<TData, TVariables>, options: useLoadableQuery.Options & {
        ...
        */
        interface Modern {
            ...
            * @returns A tuple in the form of `[loadQuery, queryRef, handlers]`
            */
            <TData, TVariables extends OperationVariables, TOptions extends useLoadableQuery.Options>(query: DocumentNode | TypedDocumentNode<TData, TVariables>, options: TOptions & useLoadableQuery.OptionsFor<TOptions>): useLoadableQuery.ResultForOptions<TData, TVariables, TOptions>;
        }
