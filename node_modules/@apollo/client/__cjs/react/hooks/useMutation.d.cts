...
import type { LazyType, NoInfer, OptionWithFallback, Prettify, SignatureStyle } from "@apollo/client/utilities/internal";
...
export declare namespace useMutation {
    ...
    type OptionsFor<TOptions> = Exclude<keyof TOptions, keyof useMutation.Options<any, any, any, any>> extends infer InvalidOptionNames extends string ? [
        InvalidOptionNames
        ...
        */
        interface Modern {
            ...
            */
            ...
            }, TErrorPolicy extends ErrorPolicy | undefined = undefined>(mutation: DocumentNode | TypedDocumentNode<TData, TVariables>, options?: TOptions & useMutation.OptionsFor<TOptions> & {
                /**
                * Specifies how the mutation handles a response that returns both GraphQL errors and partial results.
                * 
                * For details, see [GraphQL error policies](https://www.apollographql.com/docs/react/data/error-handling/#graphql-error-policies).
