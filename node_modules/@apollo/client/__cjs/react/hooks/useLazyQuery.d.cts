...
export declare namespace useLazyQuery {
    ...
    namespace Base {
        interface Result<TData, TVariables extends OperationVariables, TErrorPolicy extends ErrorPolicy | undefined = undefined> {
            /**
    ...
    type Result<TData, TVariables extends OperationVariables, TStates extends DataState<TData>["dataState"] = DataState<TData>["dataState"], TErrorPolicy extends ErrorPolicy | undefined = undefined> = Base.Result<TData, TVariables, TErrorPolicy> & (({
        /**
    ...
    type ResultTuple<TData, TVariables extends OperationVariables, TStates extends DataState<TData>["dataState"] = DataState<TData>["dataState"], TErrorPolicy extends ErrorPolicy | undefined = undefined> = [
        execute: ExecFunction<TData, TVariables, TErrorPolicy>,
        result: useLazyQuery.Result<TData, TVariables, TStates, TErrorPolicy>
    ];
    type ExecFunction<TData, TVariables extends OperationVariables, TErrorPolicy extends ErrorPolicy | undefined = undefined> = (...args: {} extends TVariables ? [
    ...
    type OptionsFor<TOptions> = Exclude<keyof TOptions, keyof useLazyQuery.Options<any, any>> extends (infer InvalidOptionNames extends string) ? [
        InvalidOptionNames
